...
`test/functional/test_framework/test_framework.py:VirclesTestFramework.main`.
...
def main():
    ...
    enable_virclesd = config["components"].getboolean("ENABLE_VIRCLESD")
...
class RPCCoverage():
    ...
    commands per `vircles-cli help` (`rpc_interface.txt`).
