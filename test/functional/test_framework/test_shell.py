...
class TestShell:
    """Wrapper Class for VirclesTestFramework.

    The TestShell class extends the VirclesTestFramework
    ...
    class __TestShell(VirclesTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by VirclesTestFramework child class.
            self.num_nodes = 1
