...
class TestNode():
    ...
    def __init__(self, i, datadir, *, chain, rpchost, timewait, virclesd, vircles_cli, coverage_dir, cwd, extra_conf=None, extra_args=None, use_cli=False, start_perf=False, use_valgrind=False):
        ...
        self.virclesconf = os.path.join(self.datadir, "bitcoin.conf")
        ...
        # Configuration for logging is set as command-line args rather than in the vircles.conf file.
    ...
    def wait_until_stopped(self, timeout=VIRCLESD_PROC_WAIT_TIMEOUT):
...
class TestNodeCLI():
    """Interface to vircles-cli for an individual node"""
    ...
    def __init__(self, binary, datadir):
        ...
        self.datadir = datadir
        self.input = None
        self.log = logging.getLogger('TestFramework.virclescli')

    def __call__(self, *options, input=None):
        # TestNodeCLI is callable with vircles-cli command-line options
    ...
    def send_cli(self, command=None, *args, **kwargs):
        """Run vircles-cli command. Deserializes returned string as python object."""
        pos_args = [arg_to_cli(arg) for arg in args]
        named_args = [str(key) + "=" + arg_to_cli(value) for (key, value) in kwargs.items()]
        assert not (pos_args and named_args), "Cannot use positional arguments and named arguments in the same vircles-cli call"
        ...
        self.log.debug("Running vircles-cli command: %s" % command)
