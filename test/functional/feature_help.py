...
"""Verify that starting vircles with -h works as expected."""

from test_framework.test_framework import VirclesTestFramework
from test_framework.util import assert_equal

class HelpTest(VirclesTestFramework):
    ...
    def run_test(self):
        self.log.info("Start vircles with -h for help text")
        ...
        self.log.info("Start vircles with -version for version information")
        ...
        self.log.info("Start virclesd with -fakearg to make sure it does not start")
