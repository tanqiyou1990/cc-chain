...
By default, virclesd will dump mempool on shutdown and
...
class MempoolPersistTest(VirclesTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent virclesd from writing mempool.dat to disk. Verify that `savemempool` fails")
