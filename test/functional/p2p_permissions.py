...
class P2PPermissionsTests(VirclesTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].virclesconf, encoding="utf8") as f:
            newText=f.read().replace(old, new)
        with open(self.nodes[nodeid].virclesconf, 'w', encoding="utf8") as f:
            f.write(newText)
