Vircles Core version 0.16.1 is now available from:

  <https://virlcescore.org/bin/vircles-0.16.1/>
...
- #12843 `df38b13` Test starting virclesd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure virclesd processes are cleaned up when tests end (sdaftuar)
