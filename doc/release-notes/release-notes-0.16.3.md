Vircles Core version 0.16.3 is now available from:

  <https://virlcescore.org/bin/vircles-0.16.3/>
...
been discovered in Vircles Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` virlcesconsensus: invalid flags error should be set to `virlcesconsensus_err` (afk11)
