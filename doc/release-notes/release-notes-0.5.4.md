Vircles version 0.5.4 is now available for download at:
http://sourceforge.net/projects/virlces/files/Vircles/virlces-0.5.4/
...
http://gitorious.org/virlces/virclesd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Vircles-Qt notifications under Growl 1.3.
Increase required age of Vircles-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxVircles properly when installing Vircles-Qt over it. (Windows)
