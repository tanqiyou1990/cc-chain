Vircles Core version 0.9.4 is now available from:

  https://virlces.org/bin/0.9.4/
...
this update is incompatible with the Vircles system and could lead to consensus
forks.

Vircles Core released binaries from https://virlces.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~virlces/+archive/ubuntu/virlces
- A third-party or self-compiled Vircles Core

upgrade to Vircles Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
