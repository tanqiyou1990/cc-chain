Vircles Core version *0.15.2* is now available from:

  <https://virlcescore.org/bin/vircles-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in virlces-tx (TheBlueMatt)
