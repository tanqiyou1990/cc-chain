Vircles Core version 0.10.4 is now available from:

  <https://virlces.org/bin/vircles-0.10.4/>
...
- #6953 `43c2789` Split virlces-tx into its own package
- #6953 `dfe0d4d` Include virlces-tx binary on Debian/Ubuntu
