Vircles-Qt version 0.8.2 is now available from:
  http://sourceforge.net/projects/virlces/files/Vircles/virlces-0.8.2/
...
MacOSX:
* OSX support for click-to-pay (virlces:) links
...
* Entering the 'getblocktemplate' or 'getwork' RPC commands into the Vircles-Qt debug
console will cause Vircles-Qt to crash. Run Vircles-Qt with the -server command-line
