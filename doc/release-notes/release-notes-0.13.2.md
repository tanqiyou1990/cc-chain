Vircles Core version 0.13.2 is now available from:

  <https://virlces.org/bin/vircles-0.13.2/>
...
- #8908 `4a974b2` Update virlces-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow virlces-tx to create v2 transactions (sysdrak)
