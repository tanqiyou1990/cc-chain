Vircles Core version 0.10.3 is now available from:

  <https://virlces.org/bin/vircles-0.10.3/>
...
(see https://github.com/vpubchain/virlces/pull/6793, as well as the 0.11.0
