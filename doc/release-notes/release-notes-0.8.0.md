Vircles-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/virlces/files/Vircles/virlces-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Vircles
...
New/changed settings (command-line or virlces.conf file)
--------------------------------------------------------
