# RapidCheck property-based testing for Vircles Core

## Concept

Property-based testing is experimentally being added to Vircles Core with
...
If RapidCheck is installed, Vircles Core will automatically run the
...
3. Configure Vircles Core with RapidCheck.
...
4. Build Vircles Core with RapidCheck.
    ...
    Making all in src
    [...]
    CXX      test/gen/test_vircles-crypto_gen.o
    CXX      test/test_vircles-key_properties.o
    ```
...
That's it! You are now running property-based tests in Vircles Core.
