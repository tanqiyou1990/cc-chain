...
This document provides guidelines for internationalization of the Vircles Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `virlces_en.ts` remains unchanged.
