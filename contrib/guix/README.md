# Bootstrappable Vircles Core Builds
...
- 24GB of free disk space on the partition that the Vircles Core git repository
  resides in
...
For a Vircles Core depends development environment, simply invoke
...
From the top of a clean Vircles Core repository:
