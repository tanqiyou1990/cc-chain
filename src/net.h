 ...
 * currently acceptable).  Vircles has 4 MiB here, but we need more space
...
public:
    ...
    // VIRCLES If 'true' this node will be disconnected on CMasternodeMan::ProcessMasternodeConnections()
    bool fMasternode;
...
public:
    ...
    // and in the order requested.
       // VIRCLES List of non-tx/non-block inventory items
