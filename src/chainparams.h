 ...
 * Vircles system. There are three: the main network on which people trade goods
...
public:
    ...
    // for runde
    const std::string& GetTransferAddr() const { return strTransferAddr; }
    int GetTransferPercent() const { return nTransferPercent; }
...
protected:
    ...
    // for runde blockchain
    std::string strTransferAddr;
    int nTransferPercent;
};
