...
bool ArgsManager::ParseParameters(int argc, const char* const argv[], std::string& error)
{
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (key == "-") break; //vircles-tx using stdin
        std::string val;
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Vircles
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Vircles
    // Mac: ~/Library/Application Support/Vircles
    // Unix: ~/.vircles
#ifdef WIN32
    // Windows
