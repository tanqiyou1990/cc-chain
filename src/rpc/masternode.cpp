...
UniValue masternode(const JSONRPCRequest& request)
{
    ...
    if (strCommand == "outputs") {
        ...
        pwallet->AvailableCoins(*locked_chain, vPossibleCoins, true, nullptr, 100 * COIN, 100 * COIN, MAX_MONEY, 0, true);    //modify from 1000 to 100 by luke
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
            RPCHelpMan{"masternodelist",    
                ...
                "  payee          - Print Vircles address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
