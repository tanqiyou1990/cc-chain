...
void SyscoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Vircles address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vircles: URIs)"));
   ...
   // VIRCLES
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Vircles addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Vircles addresses"));
    ...
    openAction->setStatusTip(tr("Open a vircles: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Vircles command-line options").arg(PACKAGE_NAME));
...
void SyscoinGUI::setClientModel(ClientModel *_clientModel)
{
    ...
    if(_clientModel)
    {
        ...
        if (optionsModel && trayIcon) {
            ...
            connect(optionsModel, &OptionsModel::hideTrayIconChanged, this, &SyscoinGUI::setTrayIconVisible);
...
void SyscoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Vircles network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
void UnitDisplayStatusBarControl::createContextMenu()
{
    ...
    {
        QAction *menuAction = new QAction(QString(SyscoinUnits::longName(u)), this);
