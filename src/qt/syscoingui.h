...
/**
  Vircles GUI main class. This class represents the main window of the Vircles UI. It communicates with both the client and
...
public Q_SLOTS:
    ...
    /** VIRCLES Set additional data sync status shown in the UI */
...
public Q_SLOTS:
    ...
    /** VIRCLES Switch to masternode page */
