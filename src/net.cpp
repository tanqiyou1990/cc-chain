...
void CNode::copyStats(CNodeStats &stats)
{
    ...
    // Raw ping time is in microseconds, but show it to user as whole seconds (Vircles users should be well used to small numbers with many decimal places by now :)
...
void CConnman::AcceptConnection(const ListenSocket& hListenSocket) {
    ...
    // VIRCLES don't accept incoming connections until fully synced
...
void CConnman::OpenMasternodeConnection(const CAddress &addrConnect) {
    // open as block relay + mn (no tx)
    OpenNetworkConnection(addrConnect, false, NULL, NULL, false, false, false, true, true);
}
...
bool CConnman::Start(CScheduler& scheduler, const Options& connOptions)
{
    ...
    // VIRCLES Initiate masternode connections
